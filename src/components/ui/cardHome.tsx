...
export default function CardHome({title, baseImg, activeImg}: cardProps) {
    ...
    return (
        <div
            className={`min-h-[350px] max-h-[350px] border-4 border-black rounded-lg col-span-1 flex flex-col items-center h-full pt-4 pb-4 transition-all duration-500 cursor-pointer relative overflow-hidden `}
